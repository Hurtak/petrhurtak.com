...
export const Table = (props: { heading?: React.ReactNode; children: React.ReactNode }) => {
  const heading = (() => {
...
export const Tc = ({
  ...
  return (
    <Component noWrap={noWrap} center={center} style={style} colSpan={colSpan} rowSpan={rowSpan}>
      {children}
    </Component>
  );
};
