...
<a class="snippet" id="snippet-1" href="./snippets/example.html">Live code example snippet</a>
<script>
  (function () {
...
ask for snippet data with API and then render
