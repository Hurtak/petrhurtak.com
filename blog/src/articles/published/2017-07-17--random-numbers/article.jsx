...
import { Code, H1, Link, List, Li, P } from "../../components";

export default () => (
  <>
    <List>
      <Li>
        In JavaScript, most common way to get pseudo random values is from the <Code>Math.random()</Code> standard
        library function.
        <List>
    ...
    <List>
      <Li>
        In case you would want a random number in a certain range, there is no standard library function for that. So
        you either need to do the range transformations by yourself or use some package/library.
      </Li>
    </List>
