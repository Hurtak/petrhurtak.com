...
const HomeThree: NextPage<Props> = (props) => (
  <>
    <h1>Hey, I&apos;m Petr</h1>
    ...
    <style jsx>{`
      @import url("https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@500;700&family=Work+Sans:wght@400;500&family=IBM+Plex+Mono:wght@400;500&display=swap");
