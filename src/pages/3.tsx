...
const HomeFive: NextPage<Props> = (props) => (
  <>
    <h1>Hey, I&apos;m Petr</h1>
    ...
    <style jsx global>{`
      @import url("https://fonts.googleapis.com/css2?family=Source+Serif+4:wght@400;600;700&family=Public+Sans:wght@400;500&family=IBM+Plex+Mono:wght@400;500&display=swap");
