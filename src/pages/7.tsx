...
const HomeSeven: NextPage<Props> = (props) => (
  <>
    <h1>Hey, I&apos;m Petr</h1>
    ...
    <style jsx global>{`
      @import url("https://fonts.googleapis.com/css2?family=Instrument+Serif&family=Space+Grotesk:wght@400;500&family=JetBrains+Mono:wght@400;500&display=swap");
