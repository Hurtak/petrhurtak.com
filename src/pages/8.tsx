...
const HomeEight: NextPage<Props> = (props) => (
  <>
    <h1>Hey, I&apos;m Petr</h1>
    ...
    <style jsx global>{`
      @import url("https://fonts.googleapis.com/css2?family=EB+Garamond:wght@500;700&family=Figtree:wght@400;500&family=Roboto+Mono:wght@400;500&display=swap");
