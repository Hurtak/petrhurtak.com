...
test("addIdsToHeadings", t => {
  ...
  t.deepEqual(fn("<h2>HELLO</h2>"), '<h2 id="hello">HELLO</h2>');
  t.deepEqual(
    fn("<h2>longer heading</h2>"),
    '<h2 id="longer-heading">longer heading</h2>'
  );
  ...
  t.deepEqual(fn("<h2>foo 1.0.0</h2>"), '<h2 id="foo-1-0-0">foo 1.0.0</h2>');
  t.deepEqual(
    fn("<h2>www.google.com</h2>"),
    '<h2 id="www-google-com">www.google.com</h2>'
  );
  t.deepEqual(
    fn("<h2>some underscore_case</h2>"),
    '<h2 id="some-underscore-case">some underscore_case</h2>'
  );
  t.deepEqual(
    fn("<h2>a snake-case</h2>"),
    '<h2 id="a-snake-case">a snake-case</h2>'
  );
